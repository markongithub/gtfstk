...
rows = [
    ...
    ['calendar', True, 'service_id', True, 'str'],
    ['calendar', True, 'monday', True, 'int'],
    ['calendar', True, 'tuesday', True, 'int'],
    ['calendar', True, 'wednesday', True, 'int'],
    ['calendar', True, 'thursday', True, 'int'],
    ['calendar', True, 'friday', True, 'int'],
    ['calendar', True, 'saturday', True, 'int'],
    ['calendar', True, 'sunday', True, 'int'],
    ['calendar', True, 'start_date', True, 'str'],
    ['calendar', True, 'end_date', True, 'str'],
